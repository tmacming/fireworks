    ...
    <div>
        ...
        <Detail title="资质荣誉" v-bind:items="items">
            <section :class="$style.content">
                <ul>
                    <li>
                        <img src="http://hndqhp.com/Content/UploadFiles/201705240152369.jpg" alt="">
                    </li>
                    <li>
                        <p>安全生产许可证</p>
                        <strong>
         ...
         湖南德强花炮有限公司是桃源县资质齐全的年生产规模达4000万元的鞭炮、礼炮、烟花生产型的烟花爆竹生产企业。以弘扬中华民族传统文化的内涵己任，让德强花炮给千家万户带来平安，带来吉祥。电话：400-0736-338     </strong>    
                    ...
                    <li>
                        <router-link :to="{ name: 'biaozhun'}">上一篇</router-link>
                        <router-link :to="{ name:'zhizhao' }">下一篇</router-link>
                    </li>
                </ul>
            </section>
        </Detail>
